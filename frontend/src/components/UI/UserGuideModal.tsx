...
export const UserGuideModal: React.FC<UserGuideModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-3 sm:p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto glass-panel border border-slate-200 dark:border-saffron/30 rounded-2xl shadow-2xl p-4 sm:p-5 text-slate-900 dark:text-white">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/10 pb-3 mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold font-outfit text-slate-900 dark:text-white">WeatherGPT Quick User Guide</h2>
              <p className="text-[11px] text-slate-500 dark:text-slate-400">Everything you need to know about navigating & using the AI platform</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/15 transition-colors"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          ...
          <div className="p-4 rounded-xl bg-slate-100/90 dark:bg-slate-800/60 border border-slate-200/80 dark:border-white/10 hover:border-saffron/40 transition-all">
          ...
          <div className="p-4 rounded-xl bg-slate-100/90 dark:bg-slate-800/60 border border-slate-200/80 dark:border-white/10 hover:border-cyan-400/40 transition-all">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-cyan-500/20 text-cyan-600 dark:text-cyan-400">
                <MapPin className="w-5 h-5" />
              </div>
              <h3 className="font-semibold text-cyan-600 dark:text-cyan-400 text-sm">2. Pin Permanent Home Location</h3>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              Search any micro-location (e.g. <em>Sathyamangalam, Annur, Mettupalayam</em>) and click <strong>"Pin as Home"</strong> to save your coordinates permanently.
            </p>
          </div>

          {/* Card 3: Real-Time IMD Disaster Warning */}
          <div className="p-4 rounded-xl bg-slate-100/90 dark:bg-slate-800/60 border border-slate-200/80 dark:border-white/10 hover:border-red-400/40 transition-all">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-red-500/20 text-red-500 dark:text-red-400">
                <ShieldAlert className="w-5 h-5" />
              </div>
              <h3 className="font-semibold text-red-500 dark:text-red-400 text-sm">3. Live Disaster Warnings & IMD Radar</h3>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-slate-100/90 dark:bg-slate-800/60 border border-slate-200/80 dark:border-white/10 hover:border-emerald-400/40 transition-all">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-emerald-500/20 text-emerald-600 dark:text-emerald-400">
                <Waves className="w-5 h-5" />
              </div>
              <h3 className="font-semibold text-emerald-600 dark:text-emerald-400 text-sm">4. Air Quality & Marine Tides</h3>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
