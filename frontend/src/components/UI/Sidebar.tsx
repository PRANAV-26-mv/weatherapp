...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* ---------------------------------------------------- */}
      <header className="lg:hidden sticky top-0 z-40 glass-panel border-b border-white/10 px-4 py-2 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-2.5">
          <button
            onClick={() => setMobileDrawerOpen(true)}
            className="p-2 rounded-xl bg-white/10 hover:bg-saffron/20 text-white hover:text-saffron transition-all border border-white/10"
            title="Open Menu"
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-full bg-saffron/20 text-saffron border border-saffron/30 font-bold text-xs flex items-center gap-1 shadow-sm"
          >
          ...
          <button
            ...
            className="p-2 rounded-full bg-saffron text-black font-bold shadow-md shadow-saffron/30"
          ...
          <button
            ...
            className="p-2 rounded-full bg-white/10 text-white hover:text-saffron transition-all"
      ...
      {mobileDrawerOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          {/* Drawer Container */}
          <div className="relative w-72 max-w-[85vw] glass-panel border-r border-white/15 h-full flex flex-col justify-between z-50 shadow-2xl overflow-y-auto animate-in slide-in-from-left duration-300">
            <div>
              {/* Drawer Header */}
              ...
              <div className="p-3 border-b border-white/10">
                <form onSubmit={(e) => { handleSearchSubmit(e); setMobileDrawerOpen(false); }} className="relative">
                  <input
                    ...
                    className="w-full glass-input text-xs pl-8 pr-3 py-1.5 rounded-xl border border-white/15 focus:border-saffron"
                  />
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                {onOpenLanguageModal && (
                  <button
                    ...
                    className="flex-1 px-3 py-2 rounded-xl glass-pill text-xs font-bold text-gray-200 hover:text-white hover:border-saffron/50 flex items-center justify-center gap-1.5"
                  >
                ...
                <button
                  onClick={onToggleTheme}
                  className="p-2 rounded-xl glass-pill text-white hover:bg-white/10"
                >
                  {theme === 'dark' ? <Sun className="w-4 h-4 text-amber-400" /> : <Moon className="w-4 h-4 text-indigo-400" />}
                </button>
              </div>
