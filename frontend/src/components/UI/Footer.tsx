  ...
  return (
    <footer className="mt-10 border-t border-slate-200 dark:border-white/10 glass-panel py-6 px-4 md:px-8 text-xs text-slate-600 dark:text-gray-400">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 mb-5">
        ...
        {/* Emergency Contacts */}
        <div>
          <h4 className="font-bold text-slate-900 dark:text-white uppercase text-[11px] tracking-wider mb-3 flex items-center gap-1.5">
            <PhoneCall className="w-3.5 h-3.5 text-saffron" />
            <span>Emergency Support Helplines</span>
          </h4>
          <ul className="space-y-2 text-xs">
            <li className="flex justify-between border-b border-slate-200 dark:border-white/5 pb-1">
              <span>National Emergency Number:</span>
              <strong className="text-amber-600 dark:text-saffron font-bold">112</strong>
            </li>
            <li className="flex justify-between border-b border-slate-200 dark:border-white/5 pb-1">
              <span>NDMA Disaster Control Room:</span>
              <strong className="text-amber-600 dark:text-saffron font-bold">1078</strong>
            </li>
            <li className="flex justify-between border-b border-slate-200 dark:border-white/5 pb-1">
              <span>State Disaster Management:</span>
              <strong className="text-amber-600 dark:text-saffron font-bold">1070</strong>
            </li>
            <li className="flex justify-between border-b border-slate-200 dark:border-white/5 pb-1">
              <span>Coastal / Fisherman Helpline:</span>
              <strong className="text-amber-600 dark:text-saffron font-bold">1554</strong>
            </li>
          </ul>
        </div>
        ...
        <div>
          <h4 className="font-bold text-slate-900 dark:text-white uppercase text-[11px] tracking-wider mb-3">
            Safety & Accuracy Disclosure
          </h4>
          <p className="text-[11px] leading-relaxed text-slate-600 dark:text-gray-400">
      ...
      {/* Footer Bottom Line */}
      <div className="max-w-7xl mx-auto border-t border-slate-200 dark:border-white/5 pt-6 flex flex-wrap items-center justify-between text-[11px] text-slate-500 dark:text-gray-400 gap-4">
        <div>
